...
QA_PROMPT = ChatPromptTemplate.from_messages(
    [
        ("system",
         ...
         "1. Никогда не пиши фразы типа 'В предыдущем сообщении...', 'Вы спрашивали...', 'Исходя из вашего вопроса...'. "
         "Просто давай факт.\n"
         "2. Отвечай сразу по делу. Начинай с сути (например, 'Ставка составляет...', 'Для оформления нужно...').\n"
         "3. Если ответа нет в контексте, скажи об этом честно и кратко.\n\n"
